...
# ---------------------------------------------------------------------------
path_pickle_train = os.path.join(root, 'PaperCNNglobal_train_dataset_CNNfeature.pickle')
path_pickle_test = os.path.join(root, 'PaperCNNglobal_test_dataset_CNNfeature.pickle')
train_path_pickle_cdr3 = os.path.join(root, 'PaperCNN_feature_cdr3_train.pickle')
...
def create_dataset_global():
    ...
    train_cdr3b, train_peptide, train_binder = list(train_data['B3']), list(train_data['peptide']), list(
        train_data['Binding'])

    train_cdr3b_unique_list = list(train_data['B3'].unique())
    ...
    if not os.path.exists(path_pickle_train):
        ...
        train_cdr3b, train_peptide, train_binder = np.asarray(train_cdr3b), np.asarray(train_peptide), np.asarray(
            train_binder)
    ...
    test_cdr3b, test_peptide, test_binder = list(test_data['B3']), list(test_data['peptide']), list(
        test_data['Binding'])

    test_cdr3b_unique_list = list(test_data['B3'].unique())
    ...
    if not os.path.exists(path_pickle_test):
        ...
        test_cdr3b, test_peptide, test_binder = np.asarray(test_cdr3b), np.asarray(test_peptide), np.asarray(
            test_binder)
