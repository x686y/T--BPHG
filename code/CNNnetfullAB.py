...
model_dir = str(args.secdir) + '_' + str(args.terdir) + '_GuoAndXiacaiyang_CNNAB'  
...
train_path_pickle_cdr3 = os.path.join(root,'GuoAndXiacaiyang_CNN_feature_cdr3_train.pickle')  
...
# tcra_train = enc_list_bl_max_len(train_data.tra_cdr3, blosum50_20aa, 20)  
...
dfhistory = {'epoch': epoch,
             ...
             'val_auc_roc': val_auc_roc, 'val_specificity':val_specificity,'val_F1':val_f1_score,'val_precision':val_precision,'val_recall':val_recall} 
df = pd.DataFrame(
    dfhistory) 
...
predictions = best_auc_model.predict(validation_inputs)  
...
output_file = os.path.join(root2, "IMMREPNoGNN_pred_fold0.tsv")
# output_file = os.path.join(root2, "nettcr_balNoGNN_pred_fold4.tsv")  
# output_file = os.path.join(root2, "nettcr_strict4_5foldsNoGNN_pred_fold4.tsv") 

# output_file = os.path.join(root2, "nettcrfullNoGNN_pred_fold3.tsv")  
# output_file = os.path.join(root2, "Public2_GuoAndXiacaiyangNoGNN_pred_fold0.tsv")  
