...
auprc_values = [0.463, 0.406, 0.416, 0.613, 0.619, 0.637, 0.638, 0.662, 0.519, 0.671]
std_devs = [0.020, 0.015, 0.013, 0.008, 0.012, 0.002, 0.010, 0.007, 0.008, 0.010]
...
# 保存图像到指定路径
save_path = r'D:\xy\HeteroTCR-main\5folds_visual\picture\compareNetfullAUPRC.png'
