...
output_path = r'D:\xy\HeteroTCR-main\5folds_visual\picture\Netstrictdata.png'
...
plt.title("NetTCR_strict", fontsize=14,fontweight='bold')
# 在图的左上方添加字母"B"
# plt.text(-0.02, 1.05, 'C', fontsize=20, fontweight='bold', va='center', ha='center', transform=plt.gca().transAxes)
