...
# AUROC值和标准差
auroc_values = [0.510, 0.525, 0.504, 0.520, 0.499, 0.530, 0.554, 0.553, 0.565, 0.877]
std_devs = [0.023, 0.018, 0.020, 0.041, 0.021, 0.038, 0.054, 0.056, 0.008, 0.033]
...
# 保存图像到指定路径
save_path = r'D:\xy\HeteroTCR-main\5folds_visual\picture\compareNetbalAUROC.png'
