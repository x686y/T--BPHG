...
# 文件路径
train_file = r'D:\xy\HeteroTCR-main\data\nettcr_bal5folds\fold0\train_data.tsv'
test_file = r'D:\xy\HeteroTCR-main\data\nettcr_bal5folds\fold0\test_data.tsv'
output_path = r'D:\xy\HeteroTCR-main\5folds_visual\picture\Netbaldata.png'
...
plt.title("NetTCR_bal", fontsize=14,fontweight='bold')
# 在图的左上方添加字母"B"
# plt.text(-0.02, 1.05, 'B', fontsize=20, fontweight='bold', va='center', ha='center', transform=plt.gca().transAxes)
