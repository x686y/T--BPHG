...
# 计算每个模型的AUPRC
auprc_baseline = [0.623, 0.602, 0.630, 0.633, 0.606]
auprc_taβ_bphg = [0.646, 0.637, 0.622, 0.664, 0.634]
auprc_no_gnn = [0.644, 0.628, 0.619, 0.656,0.624]
...
# 在图的左上方添加字母"A"
# plt.text(-0.05, 1.05, 'F', fontsize=14, fontweight='bold', va='center', ha='center', transform=plt.gca().transAxes)
...
# 保存图像
save_path = os.path.join(save_dir, 'XiaorongnetStrict_auprc_boxplot.png')
