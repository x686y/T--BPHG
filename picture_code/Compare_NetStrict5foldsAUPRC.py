...
auprc_values = [0.521, 0.531, 0.632, 0.580, 0.588, 0.613, 0.624, 0.632, 0.624, 0.641]
std_devs = [0.025, 0.038, 0.032, 0.041, 0.042, 0.037, 0.041, 0.040, 0.032, 0.036]
...
# 保存图像到指定路径
save_path = r'D:\xy\HeteroTCR-main\5folds_visual\picture\compareNetStrictAUPRC.png'
