...
# 计算每个模型的AUPRC
auprc_baseline = [0.612, 0.601, 0.592, 0.622, 0.641]
auprc_taβ_bphg = [0.685, 0.653, 0.671, 0.673, 0.672]
auprc_no_gnn = [0.652, 0.666, 0.664, 0.661,0.666]
...
# 在图的左上方添加字母"A"
# plt.text(-0.05, 1.05, 'D', fontsize=14, fontweight='bold', va='center', ha='center', transform=plt.gca().transAxes)
...
# 保存图像
save_path = os.path.join(save_dir, 'Xiaorongnetfull_auprc_boxplot.png')
